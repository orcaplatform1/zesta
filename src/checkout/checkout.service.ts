    ...
    const order = await this.prisma.$transaction(async (tx) => {
      const created = await tx.order.create({
        data: {
          ...
          billingCity: dto.billingSameAsShipping === false ? dto.billingCity : undefined,
          billingDistrict: dto.billingSameAsShipping === false ? dto.billingDistrict : undefined,
          billingPostalCode: dto.billingSameAsShipping === false ? dto.billingPostalCode : undefined,
          billingAddressLine: dto.billingSameAsShipping === false ? dto.billingAddressLine : undefined,
          subtotal,
          shippingCost,
          discountTotal,
          total,
